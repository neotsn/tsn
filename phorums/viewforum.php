...
$template->assign_vars(array(
    'AJAX_DATA_ID'                 => ($auth->acl_get('f_post', $forum_id) || $user->data['user_id'] == ANONYMOUS) ? $forum_id : '',
    'AJAX_DATA_ID_PARAM'           => ($auth->acl_get('f_post', $forum_id) || $user->data['user_id'] == ANONYMOUS) ? 'f' : '',
    'AJAX_DATA_MODE'               => ($auth->acl_get('f_post', $forum_id) || $user->data['user_id'] == ANONYMOUS) ? 'post' : '',
    'AJAX_DATA_URL_PATH'           => ($auth->acl_get('f_post', $forum_id) || $user->data['user_id'] == ANONYMOUS) ? $phpbb_root_path . "posting.$phpEx" : '',
