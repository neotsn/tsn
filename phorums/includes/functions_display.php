...
function display_forums($root_data = '', $display_moderators = true, $return_moderators = false)
{
    ...
    foreach ($forum_rows as $row) {
        ...
        $template->assign_block_vars('forumrow', array(
                ...
                'LAST_POSER_AVATAR'    => get_username_string('avatar', $row['forum_last_poster_id'], $row['forum_last_poster_name'], $row['forum_last_poster_colour'], false, false, $subAvatar),
...
function smart_excerpt($message, $limit = null)
{

    // Drop the HTML characters, except these simple ones
    $message = preg_replace('/<(\/*?)(?!(em|p|\s*\/|strong))\w+?.+?>/', ' ', $message);
